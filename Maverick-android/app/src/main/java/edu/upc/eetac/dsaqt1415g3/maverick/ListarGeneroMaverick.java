 ...
 */
public class ListarGeneroMaverick extends ListActivity {
    ...
    private class FetchMaverickTask extends
        ...
        protected SongsCollection doInBackground(Void... params) {
            ...
            try {
                songs = MaverickAPI.getInstance(ListarGeneroMaverick.this).StyleSongsRock();
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(ListarGeneroMaverick.this);
